...
def food_dialouge():
    ...
    if is_human >= 1: 
        ...
        input("...and, as far as I'm aware, all living things must eat to survive. ")
        input("Therefore you must eat. ")
...
def space_dialouge():
    ...
    print("...that's " + 13.4 * 365.25 + " billion days that have happened")
