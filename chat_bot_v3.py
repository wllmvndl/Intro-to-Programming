...
def food_dialouge():
    ...
    if "no" in answer:
        ...
        input("All living things must eat to survive. ")
        input("So, it stands to reason you eat too. ")
...
def self_centered_dialouge():
    print("Weren't we already doing that?")
...
def no_subject():
    ...
    if data_gathered == 10:
        print("Data requirement achieved.")
        talking = False
    else:
...
def play():
    ...
    while talking == True:
        ...
        elif "sport" in responce or "soccer" in responce or "football" in responce:
            sportsdialouge()
        elif "food" in responce:
            food_dialouge()
        elif "myself" in responce or "me" in responce:
